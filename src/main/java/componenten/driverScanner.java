...
public class driverScanner extends Thread {
    ...
    public void run() {
        ...
        for (File path : paths) {
            ...
            String pattern = "*.txt";
            String patternXLSX = "*.XLSX";
            String patternODS = "*.ODS";
            String patternPDF = "*.pds";

            Finder finder = new Finder(pattern);
            Finder finderXLSX = new Finder(patternXLSX);
            Finder finderODS = new Finder(patternODS);
            Finder finderPDF = new Finder(patternPDF);
            try {
